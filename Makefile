...
ACLOCAL = ${SHELL} '/Users/pforret/Code/pforret/packages/leqm-nrt/missing' aclocal-1.18
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/Users/pforret/Code/pforret/packages/leqm-nrt/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/pforret/Code/pforret/packages/leqm-nrt/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/pforret/Code/pforret/packages/leqm-nrt/missing' automake-1.18
AWK = gawk
CC = gcc
...
LDFLAGS = -L/opt/homebrew/lib -L/usr/lib -L/usr/lib/di -L/usr/local/lib -L/usr/local/lib/di
LIBOBJS = 
LIBS = -lsndfile -lpthread -lm 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/Users/pforret/Code/pforret/packages/leqm-nrt/missing' makeinfo
MKDIR_P = mkdir -p
OBJEXT = o
PACKAGE = leqm-nrt
...
abs_top_srcdir = /Users/pforret/Code/pforret/packages/leqm-nrt
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /Users/pforret/Code/pforret/packages/leqm-nrt/install-sh
